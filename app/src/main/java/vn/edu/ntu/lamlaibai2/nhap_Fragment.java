...
public class nhap_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nhap_, container, false);
        addView(view);
        getdata();
        addEvent();
    ...
    private void addView(View view) {
        ...
        edtdiachi = view.findViewById(R.id.txtaddress);
        edtid = view.findViewById(R.id.txtid);
        btsave = view.findViewById(R.id.btsave);
        toolbar = view.findViewById(R.id.tbnhap);
        navController = NavHostFragment.findNavController(nhap_Fragment.this);
    ...
    private void getdata() {
        ...
        if(data!=null)
        {
            ...
            {
                edtid.setText(String.valueOf(id));
                edtten.setText(data.getString("name"));
    ...
    private void addEvent() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                navController.navigate(R.id.action_nhap_Fragment_to_danhsach_Fragment);
            }
        });
