...
public class danhsach_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_danhsach_, container, false);
        addview(view);
        getData();
        addEvent();
        return view;
    ...
    private void addview(View view) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(danhsach_Fragment.this.getActivity()));

        navController = NavHostFragment.findNavController(danhsach_Fragment.this);
    ...
    private void addEvent() {
        toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                navController.navigate(R.id.action_danhsach_Fragment_to_nhap_Fragment,data);
                return false;
            }
        });
    }
